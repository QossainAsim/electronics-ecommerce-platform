...
// ✅ HELPER: Get valid deal include configuration
function getValidDealInclude() {
  return {
    where: {
      isActive: true,
  ...
  if(mode === "admin"){
    const adminProducts = await prisma.product.findMany({
      include: {
        ...
        images: true,
        deal: getValidDealInclude(),  // ✅ FIXED: Only active, non-expired deals
      },
    });
...
// ✅ FIXED: Method for updating existing product - NOW INCLUDES totalStock and reorderLevel
