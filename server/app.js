...
const orderRouter = require("./routes/order"); // ✅ FIXED: Changed from customer_orders to order
...
app.use("/api/orders", orderRouter); // ✅ Now uses the correct order.js controller
