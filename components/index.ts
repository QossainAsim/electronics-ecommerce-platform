...
// Enhanced components (only export if files exist)
export { default as HeroSlider } from "./HeroSlider";
export { default as CategoryMenuEnhanced } from "./CategoryMenuEnhanced";
export { default as IncentivesEnhanced } from "./IncentivesEnhanced";
