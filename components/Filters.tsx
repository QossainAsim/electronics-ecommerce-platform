...
// Version: 1.1 - Increased price limit
...
const Filters = () => {
  ...
  const [inputCategory, setInputCategory] = useState<InputCategory>({
    ...
    priceFilter: { text: "price", value: 10000000 }, // ✅ CHANGED: 10 million max (or set to 1000000 for 1 million)
      ...
      <div className="flex flex-col gap-y-1">
        ...
        <div>
          <input
            type="range"
            min={0}
            max={10000000}  // ✅ CHANGED: 10 million max
            step={10000}    // ✅ CHANGED: Step by $10,000
          ...
          />
          <span>{`Max price: $${inputCategory.priceFilter.value.toLocaleString()}`}</span>
        </div>
      </div>
